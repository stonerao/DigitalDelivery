/**
 * 此文件作用于 `vite.config.js` 的 `optimizeDeps.include` 依赖预构建配置项
 ...
 * 温馨提示：如果您使用的第三方库是全局引入，也就是引入到 src/main.js 文件里，就不需要再添加到 include 里了，因为 vite 会自动将它们缓存到 node_modules/.vite
 */
const include = [
  "qs",
  "mitt",
